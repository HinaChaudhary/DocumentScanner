...
public class ScannerLine extends ViewGroup {
    ...
    public ScannerLine(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScannerLine(Context context, AttributeSet attrs, int defStyle) {
